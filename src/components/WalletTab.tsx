...
import { getBalances, buildTransaction, walletIsLocked, unlockWallet } from '../postClient';
...
export const WalletTab = ({ walletPassword }: WalletTabProps) => {
  ...
  const handleTransfer = async () => {
    if (!transferForm.recipient || !transferForm.amount || !walletPassword) return;
        ...
        <div className="input-group">
          ...
          <div className="button-group">
            ...
            <button 
              ...
              disabled={isTransferring || !transferForm.recipient || !transferForm.amount || !walletPassword}
            >
